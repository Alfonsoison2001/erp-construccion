...
export default function BudgetTable({ grouped, grandTotal }) {
      ...
      <table className="w-full">
        ...
        <tbody>
          ...
          <tr className="bg-gray-50 font-semibold border-t-2">
            <td colSpan={8} className="px-4 py-3 text-right">Total Presupuesto:</td>
...
function ConceptRows({ concept, expanded, onToggle }) {
  return (
    <>
      <tr
